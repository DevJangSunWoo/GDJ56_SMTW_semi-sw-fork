...
<section>
	...
	<div style="height: 50px;">
		<div style="display: flex; float: right;">
			<select id="stateSort" class="form-select"
	...
	<div style="height: 700px">
		<div style="display: flex">
			<div style="border: 0px solid yellow; width: 400px; height: 700px">
				<div class="sidemenu">
					<div>
						<a href="<%=request.getContextPath()%>/community/reviewBasic.do"><p>커뮤니티</p></a>
					</div>
					<div>
						<a href="<%=request.getContextPath()%>/friends/friendsList.do"><p>워홀
								프렌즈 구하기</p></a>
					</div>
					<div>
						<a href="<%=request.getContextPath()%>/community/reviewBasic.do"><p>생생후기</p></a>
					</div>
				</div>
			</div>
			<div
				style="border: 0px solid red; width: 1100px; height: 850px; margin-left: 80px;">
				<div style="display: flex">
					<%
					if (review == null || review.isEmpty()) {
					%>
					<div
						style="border: 0px solid green; width: 270px; height: 300px; text-align: center;">
						<P>조회된 후기가 없습니다.</P>
					</div>
					<!--데이터 출력  -->
					<%
					...
					<div
						style="border: 0px solid green; width: 270px; height: 300px; text-align: center;">
						<div
							style="border: 0px solid magenta; width: 180px; height: 230px; margin-left: 50px; margin-top: 5px;">
							<img
								src="<%=request.getContextPath()%>/upload/review/<%=r.getReviewFileName()%>"
								style="width: 100%; height: 100%; margin: auto; border-radius: 20px;">
						</div>
						<div>
							<a
								href="<%=request.getContextPath()%>/community/readReview.do?ReviewNo=<%=r.getReviewNo()%>"
								style="color: black !important; font-size: 20px !important;"><%=r.getReviewTitle()%></a>
						</div>
				...
				<!-- 페이지 바 -->
				<div
					style="border: 0px solid blue; width: 100%; height: 80px; text-align: center;">
					<nav aria-label="Page navigation example"
						style="margin-top: 30px; color: rgba(221, 160, 221, 0.508) !important;">
						<ul class="pagination justify-content-center"
							style="color: rgba(221, 160, 221, 0.508) !important;">
	...
	<div
		style="display: flex; border: 0px solid rgb(15, 231, 231); width: 100%; height: 75px; margin-left: 0px;">
		<div style="border: 0px solid yellow; width: 400px; height: 70px;"></div>
		<div
			style="border: 0px solid yellow; width: 600px; height: 70px; margin-right: 300px">
			<!-- 검색창 위치 -->
						...
						<div id="search-container" style="margin-left: 50%;">
							<div style="display: flex;">
								...
								<div id=search-nation>
									<form
										action="<%=request.getContextPath()%>/community/searchReview.do"
										class="d-flex" role="search">
										<input type="hidden" name="searchType" value="N_NAME">
										<input name="searchKeyword" class="form-control me-2"
											type="text" placeholder="나라검색" aria-label="Search">
								...
								<div id=search-city style="display: none;">
									<form
										...
										<input name="searchKeyword" class="form-control me-2"
											type="text" placeholder="도시검색" aria-label="Search">
										<button class="customBtn btnStyle" type="submit">Search</button>
									</form>
								</div>
								<div id=search-title style="display: none;">
									<form
										...
										<input name="searchKeyword" class="form-control me-2"
											type="text" placeholder="제목검색" aria-label="Search">
										<button class="customBtn btnStyle" type="submit">Search</button>
									</form>
								</div>
								<div id=search-content style="display: none;">
									<form
										...
										<input name="searchKeyword" class="form-control me-2"
											type="text" placeholder="내용검색" aria-label="Search">
										<button class="customBtn btnStyle" type="submit">Search</button>
									</form>
								</div>
								<div id=search-userId style="display: none;">
									<form
										...
										<input name="searchKeyword" class="form-control me-2"
											type="text" placeholder="작성자(아이디)검색" aria-label="Search">
										<button class="customBtn btnStyle" type="submit">Search</button>
									</form>
								</div>
							</div>
		...
		<div style="border: 0px solid yellow; width: 400px; height: 60px">
			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
				...
				%>
				<button
					onclick="location.assign('<%=request.getContextPath()%>/community/enrollReview.do');"
					class="btn btn-primary customBtn btnStyle" type="button"
					style="margin-left: 300px; margin-top: 15px; border: 0px; padding-top: 3px; !important;"
					value="작성">작성하기</button>
				<%
				}
				%>
			</div>
