...
<section id="review-container">
	<div>
		<form id="reviewfrm"
			action="<%=request.getContextPath()%>/community/updateReviewEnd.do"
			method="post" enctype="multipart/form-data">
			<table id="tbl-review">
				<input name="userId" type="hidden" readonly
					value="<%=oriReview.getMemberId()%>">
				<input value="<%=oriReview.getReviewNo()%>" type="hidden"
					name="reviewNo">
				<tr>
					<th>제 목</th>
					<td><input value="<%=oriReview.getReviewTitle()%>"
						name="reviewTitle" id="title" type="text" placeholder="제목"
						size="65"></td>
				</tr>
				<tr>
					<th>나라</th>
					<td><select value="<%=oriReview.getNationName()%>"
						class="form-select" name="reviewNation" required id="nation"
				...
				<tr>
					<th>도시</th>
					<td><input value="<%=oriReview.getReviewCity()%>"
						name="reviewCity" id="city" type="text" placeholder="도시" size="65"></td>
				</tr>
				<tr>
					<th>만족도</th>
					<td><input value="<%=oriReview.getReviewSat()%>"
						name="reviewSat" id="sat" type="range" placeholder="만족도" size="65"
						min="1" max="5" step="1"
						oninput="document.getElementById('value1').innerHTML=this.value;">
						<span id="value1"></span></td>
				</tr>
				<tr>
					<th>대표사진</th>
					<td><input value="<%=oriReview.getReviewFileName()%>"
						name="upFile" type="file" placeholder="" size="65"></td>
					<input type="hidden" name="oriFile"
						value="<%=oriReview.getReviewFileName()%>">
				</tr>
				<tr>
					<th colspan="2">
						<div class="cont">
							<textarea style="width: 100%;" style="height:100%;"
								name="summernote" id="summernote" placeholder="내용 입력"><%=oriReview.getReviewContnet()%></textarea>
						</div>
					</th>
				</tr>				
			...
			<div class="bt_wrap">
				<div class="d-grid gap-2 d-md-flex justify-content-md-end">
					<button onclick="update_review(this.form);"
						class="customBtn btnStyle btn btn-primary" type="button"
						style="margin-left: 690px; background-color: rgba(221, 160, 221, 0.508) !important;"
						value="수정">수정</button>
					<button onclick="cancel_review();"
						class="customBtn btnStyle btn btn-primary" type="button"
