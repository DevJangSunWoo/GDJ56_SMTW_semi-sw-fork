...
<section id="review-container">
	<div>
		<form id="reviewfrm"
			action="<%=request.getContextPath()%>/community/enrollReviewEnd.do"
			...
			<table id="tbl-review">
				...
				<tr>
					<th>제 목</th>
					<td><input name="reviewTitle" id="title" type="text"
						placeholder="제목" size="65"></td>
				</tr>
				<tr>
					<th>나라</th>
				...
				<tr>
					<th>도시</th>
					<td><input name="reviewCity" id="city" type="text"
						placeholder="도시" size="65"></td>
				</tr>
				<tr>
					<th>만족도</th>
					<td><input name="reviewSat" id="sat" type="range"
						placeholder="만족도" size="65" min="1" max="5" step="1"
